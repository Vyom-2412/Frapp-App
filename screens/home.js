        ...
        <View style={styles.contentContainer}>
          <View style={{ flex: 0.5 }}>
            <Text style={styles.contentText}>
              Experience the virtual experience of trying out our different
              frames from our wide collection on your mobile phone before making
              any purchase just how you would in an offline store
            </Text>
          </View>
          <View style={{ flexDirection: 'row', flex: 0.25 }}>
            <View style={{ flex: 0.5 }}>
              <Image
                source={require('../assets/glasses-purple.png')}
                style={{ height: 64, width: 160 }}
              />
            </View>
            <View style={{ flex: 0.5 }}>
              <Image
                source={require('../assets/glasses-9.png')}
                style={{ height: 64, width: 160 }}
              />
            </View>
          </View>
          <View style={{ flexDirection: 'row', flex: 0.25 }}>
            <View style={{ flex: 0.5 }}>
              <Image
                ...
                style={{ height: 64, width: 155 }}
              />
            </View>
            <View style={{ flex: 0.5 }}>
              <Image
                source={require('../assets/glasses-8.png')}
                style={{ height: 64, width: 160 }}
              />
            </View>
          </View>
