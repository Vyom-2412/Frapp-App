...
let data = {
  ...
  wayfarer: [
    {
      id: '4',
      image: require('../assets/glasses-purple.png'),
    },
    {
      id: '5',
      image: require('../assets/glasses-orange.png'),
    },
  ],
  rimless: [
    {
      id: '6',
      image: require('../assets/glasses-9.png'),
    },
  ],
  round: [
    {
  ...
  aviator: [
    {
      id: '7',
      image: require('../assets/glasses-sun.png'),
    },
    {
      id: '8',
      image: require('../assets/glasses-6.png'),
    },
    {
      id: '9',
      image: require('../assets/glasses-7.png'),
    },
    {
      id: '10',
      image: require('../assets/glasses-8.png'),
    },
  ],
};
              ...
              return (
                <TouchableOpacity
                  ...
                  <Image
                    ...
                    style={{ height: 30, width: 76 }}></Image>
                </TouchableOpacity>
              );
            })}
          </ScrollView>
